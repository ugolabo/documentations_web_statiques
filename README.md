...
Le création du contenu (texte, images, liens, etc.) est faite avec Markdown avec la majorité des générateurs. Le générateur sert à émuler et à construire le site en local.
